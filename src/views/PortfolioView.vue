      ...
      items: [
        {
          ...
          status: 'Snatchy is a Twitter-style social app built on Solana. Every post and like is written on-chain, giving users verifiable ownership, transparency, and censorship resistance. Wallet login replaces usernames, and Solana’s low fees enable real-time feeds at scale. I designed and built the smart contracts and frontend to create a fast, trustless social experience for the crypto community',
          tech: 'Rust, React app',
          github: 'https://github.com/BUILDPROJECT222',
          demo: 'https://snatchy.vercel.app/'
        },
        {
          id: 2,
          name: 'Elara Ai',
          imageUrl: 'sahabatmuslim',
          status: 'Elara AI is a virtual girlfriend powered by LLMs, real-time voice, and long-term memory. She personalizes conversations, remembers preferences, and stays safe-by-design with consent-focused boundaries.',
          tech: 'Typescript , css , js',
          github: 'https://github.com/BUILDPROJECT222/elara',
          demo: 'https://elara222.vercel.app/'
        },
        {
          id: 3,
          name: 'Heaven Resort',
          imageUrl: 'sistekdes',
          status: 'Heaven Resort is a stylized Roblox Club map featuring a beach-club vibe, live DJ stage, dynamic lighting, and interactive dance systems. I built custom UIs (music, VIP, bartender), role-based tags (VIP/VVIP/Sultan/Top Spender), and optimized mobile/PC performance for smooth, social party gameplay.',
          tech: 'LUA',
              ...
              <div
                ...
                <div class="flex h-12 w-12 items-center justify-center p-0 h-full w-full lg:p-0 zoom-in">
                  <img alt="HTML" loading="lazy" decoding="async" data-nimg="1" class="drop-shadow-xl rounded rounded-xl"
                    :src="item.imageUrl.startsWith('http') ? item.imageUrl : '/img/portfolio-' + item.imageUrl + '.png'">
                </div>
